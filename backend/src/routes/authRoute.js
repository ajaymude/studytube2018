...
import { getCurrentUser, refreshAccessToken, signIn, signUp, signOut } from '../controllers/authController.js';
...
authRoute.route('/sign-out').post(isAuthenticated, signOut);
